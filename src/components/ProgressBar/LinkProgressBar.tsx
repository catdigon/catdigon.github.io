...
interface Props {
    ids: string[];
    state: string;
    projectSectionProgress: MotionValue<number> | undefined;
}

export default function LinkProgressBar({ ids, state , projectSectionProgress }: Props) {
